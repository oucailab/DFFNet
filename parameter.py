def _init():  # 初始化
    ...
    parameter = {
        ...
        'tsne': True,
        'test_base': 1,
        'model_savepath': ['/root/autodl-tmp/model/Houston2013_model.pth',
                           '/root/autodl-tmp/model/Houston2018_model.pth',
                           '/root/autodl-tmp/model/Trento_model.pth',
                           '/root/autodl-tmp/model/Berlin_model.pth',
                           '/root/autodl-tmp/model/Augsburg_model.pth'],
